...
<head>
    ...
    <style>
        ...
        .card-header {
            background-color: #007bff;  /* Optional: Change card header background to blue */
        }
        h1, h2, h3, h4 {
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="image\home2.jpg" alt="image\_107317099_blooddonor976.jpg" width="100%" height="500">
                        </div>
